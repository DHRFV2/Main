repeat task.wait() until game:IsLoaded() if not isfile("Sentra.Pub") then makefolder("Sentra.Pub") end
    ...
    obj.Text = 'active user: <font color="rgb(171, 74, 255)">' .. game.Players.LocalPlayer.Name .. '</font>'
    end
    if obj.Name:lower():find('buildlabel') then
    obj.Text = 'build: <font color="rgb(171, 74, 255)">Public</font>'
    end
    end
    ...
    KeybindGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 0, 0)), ColorSequenceKeypoint.new(0.50, Color3.fromRGB(171, 74, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
    ...
    Name.Text = "[<font color=\"rgb(171, 74, 255)\">Keybinds</font>]"
    ...
    Name_2.Text = "Silent Aim: <font color=\"rgb(171, 74, 255)\">[MB1]</font>"
    ...
    WatermarkFrame.BorderColor3 = Color3.fromRGB(171, 74, 255)
    ...
    WaterMarkLabel.Text = 'Sentra.Pub<font color="rgb(74, 74, 74)"></font> - uid: <font color="rgb(74, 74, 74)">' .. uid .. '</font> / fps: <font color="rgb(171, 74, 255)">' .. fpsValue .. '</font> / ping: <font color="rgb(171, 74, 255)">' .. ping .. '</font> / time: <font color="rgb(171, 74, 255)">' .. time .. '</font>'
    end
    end)
    return Watermark
    end
    ...
    local library = {
    Title = 'Sentra.Pub<font color="rgb(74, 74, 74)"></font> | paid',
    keybind = Enum.KeyCode.RightBracket,
    Watermark = createWatermark(),
    Colors = {
    libColor = Color3.fromRGB(171, 74, 255),
    riskyColor = Color3.fromRGB(255, 0, 0),
    FontColor = Color3.fromRGB(255, 255, 255),
    MainColor = Color3.fromRGB(14, 14, 14),
    AccentColor = Color3.fromRGB(171, 74, 255),
    ...
    CloneScreenGui.Name = "Sentra.Pub_gui"

    for _, obj in pairs(menu:GetDescendants()) do
    if obj.Name:lower():find('name_esp') then
    obj.Text = '<font color="rgb(171, 74, 255)">' .. game.Players.LocalPlayer.Name .. '</font>'
    end
    end
    ...
    local NotifyOuter = library:Create('Frame', {BorderColor3 = Color3.new(171, 74, 255); Position = UDim2.new(0, 100, 0, 10); Size = UDim2.new(0, 0, 0, YSize); ClipsDescendants = true; Transparency = 0; ZIndex = 100; Parent = library.NotificationArea})
    ...
    local imageTweenStart = TweenService:Create(v, tweenInfo, {ImageColor3 = Color3.fromRGB(171, 74, 255)})
    local textTweenStart = TweenService:Create(v.text, tweenInfo, {TextColor3 = Color3.fromRGB(171, 74, 255)})
        ...
        if key.Name == "Unknown" or key.Name == "Unknown" then
            ...
            if args.gui then
                ...
                if args.type == "hold" then
                    Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(171, 74, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                else
                    if not Toggle then
                        Toggle = true
                        Name.Text = "<font color=\"rgb(255,255,255)\">" ..args.text.. ":</font>".." <font color=\"rgb(171, 74, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                        ...
                        Toggle = false
                        Name.Text = "<font color=\"rgb(125, 125, 125)\">" ..args.text.. ": /font>".." <font color=\"rgb(171, 74, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
                    end
                end
            end
        end
    ...
    if args.gui then
        Name.Visible = true
        Name.Text = args.text..": <font color=\"rgb(171, 74, 255)\">" .."["..keyName.."]".. "</font> ("..args.type..")"
    end
    ...
    writefile("Sentra.Pub/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
    ...
    local tbl = {}
    for i,v in next, listfiles("Sentra.Pub") do table.insert(tbl,v) end
